...
//? 1 - номер с которого мне нужно будет начать 
//? 1 - сколько эл-в нужно будет удалить 

let aarr = ["Я", "изучаю", "JavaScript"];

aarr.splice(1, 1); //? начиная с позиции 1, удалить 1 элемент

console.log(aarr); //? осталось ["Я", "JavaScript"]
