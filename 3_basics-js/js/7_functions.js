...
//? Сначала выведет с локальной пер Hello world! 10, потом с глобальной пер 20 п
...
//? Когда запустится ф-я calc, она нам вернет суммму 1го и 2-го аргументв
...
//? Создаем пер-ю const culcc в которую помещаем ф-ю, ф-я у нас стрелочная
